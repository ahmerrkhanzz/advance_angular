(function () {
    'use strict';
    describe('InstitutionsListService filterObjectForSubscriptionsForSubscriptions service', function () {
        ...
        it('should exist', function () {
            expect(service.filterObjectForSubscriptions).toBeDefined();
        });
        ...
        describe('When empty array provided as a parameter', function () {
            it('should return false', function () {
                var filters = {},
                    institutionData = {};
                var result = service.filterObjectForSubscriptions(filters, institutionData);
        ...
        describe('when recieve a successful response', function () {
            it('should not throw an expectation', function () {
                ...
                service.filterObjectForSubscriptions(filters, institutionData);
            }
    ...
    describe('when receiving a null response', function () {
        it('should not throw an exception', function () {
            var callback = function () {
                service.filterObjectForSubscriptions();
            }
            expect(callback).not.toThrow();
        });
    });
